...
class TestRecall(unittest.TestCase):
    ...
    def test_exact_match_recall(self):
        ...
        self.assertEqual(result.data[0].id, target_idx, "The top result should be the query vector itself")
    ...
    def test_l2_recall_topk(self):
        ...
        self.assertEqual(result_ids, ground_truth_ids, "Result order should match ground truth for Flat index")
